...
* Description: Renders a map of awesome locations to visit in Edinburgh.
*              This file consists of 3 main components, the MODEL of locations,
*              the VIEW MODEL and a function to LOAD the MAP.
* Version: August 2016
*/

/*
* MODEL of locations and their attributes
*/
...
/*
* VIEW MODEL
* Contains functions to add markers, retrieve and show data, update infowindow content and filter locations
*/
...
function ViewModel() {
  ...
  /*
  * Function to set infowindow content (either a Yelp review snippet or as a fallback, a description of the location)
  * Special thanks to Udacity coach Mark Nguyen who described the oAuth JavaScript implementation in the course forums
  * @param (string) title - The location title to search for on Yelp
  * @param (string) description - The location description to be used as a fallback in case we can't get a Yelp review snippet
  */
  ...
  // Turn the JSON array of location objects into an observable array
  ...
  self.locations().forEach(function(location) {
    ...
    // Extend bounds, auto-zoom and auto-center the map
